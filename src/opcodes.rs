...
//6x
Op::new(RTS_IMPL, 1, 6, ZERO),
Op::new(ADC_IND_X, 2, 6, INDIRECTx),
ILLEGAL,
ILLEGAL,
ILLEGAL,
Op::new(ADC_ZP, 2, 3, ZEROPAGE),
Op::new(ROR_ZP, 2, 5, ZEROPAGE),
ILLEGAL,
Op::new(PLA_IMPL, 1, 4, ZERO),
Op::new(ADC_IMM, 2, 2, IMMEDIATE),
Op::new(ROR_ACC, 1, 2, ACCUMULATOR),
ILLEGAL,
Op::new(JMP_IND, 3, 5, INDIRECT),
Op::new(ADC_ABS, 3, 4, ABSOLUTE),
Op::new(ROR_ABS, 3, 6, ABSOLUTE),
ILLEGAL,

//7x
Op::new(BVS_REL, 2, 2, /*var */ RELATIVE),
Op::new(ADC_IND_Y, 2, 5, /*var */ INDIRECTy),
ILLEGAL,
ILLEGAL,
ILLEGAL,
Op::new(ADC_ZP_X, 2, 4, ZEROPAGEx),
Op::new(ROR_ZP_X, 2, 6, ZEROPAGEx),
ILLEGAL,
Op::new(SEI_IMPL, 1, 2, ZERO),
Op::new(ADC_ABS_Y, 3, 4, /*var */ ABSOLUTEy),
ILLEGAL,
ILLEGAL,
ILLEGAL,
Op::new(ADC_ABS_X, 3, 4, /*var */ ABSOLUTEx),
...
//9x
Op::new(BCC_REL, 2, 2, /*var */ RELATIVE),
Op::new(STA_IND_Y, 2, 6, INDIRECTy),
ILLEGAL,
ILLEGAL,
Op::new(STY_ZP_X, 2, 4, ZEROPAGEx),
Op::new(STA_ZP_X, 2, 4, ZEROPAGEx),
Op::new(STX_ZP_Y, 2, 4, ZEROPAGEy),
ILLEGAL,
Op::new(TYA, 1, 2, ZERO),
Op::new(STA_ABS_Y, 3, 5, ABSOLUTEy),
Op::new(TXS_IMPL, 1, 2, ZERO),
ILLEGAL,
ILLEGAL,
Op::new(STA_ABS_X, 3, 5, ABSOLUTEx),
ILLEGAL,
ILLEGAL,

// Ax
Op::new(LDY_IMM, 2, 2, IMMEDIATE),
Op::new(LDA_IND_X, 2, 6, INDIRECTx),
Op::new(LDX_IMM, 2, 2, IMMEDIATE),
ILLEGAL,
Op::new(LDY_ZP, 2, 3, ZEROPAGE),
Op::new(LDA_ZP, 2, 3, ZEROPAGE),
Op::new(LDX_ZP, 2, 3, ZEROPAGE),
ILLEGAL,
Op::new(TAY, 1, 2, ZERO),
Op::new(LDA_IMM, 2, 2, IMMEDIATE),
Op::new(TAX, 1, 2, ZERO),
ILLEGAL,
Op::new(LDY_ABS, 3, 4, ABSOLUTE),
Op::new(LDA_ABS, 3, 4, ABSOLUTE),
Op::new(LDX_ABS, 3, 4, ABSOLUTE),
ILLEGAL,

// Bx
Op::new(BCS_REL, 2, 2, /*var */ RELATIVE),
Op::new(LDA_IND_Y, 2, 5, /* var */ INDIRECTy),
ILLEGAL,
ILLEGAL,
Op::new(LDY_ZP_X, 2, 4, ZEROPAGEx),
Op::new(LDA_ZP_X, 2, 4, ZEROPAGEx),
Op::new(LDX_ZP_Y, 2, 4, ZEROPAGEy),
ILLEGAL,
Op::new(CLV_IMPL, 1, 2, ZERO),
Op::new(LDA_ABS_Y, 3, 4, /*var */ ABSOLUTEy),
Op::new(TSX_IMPL, 1, 2, ZERO),
ILLEGAL,
Op::new(LDY_ABS_X, 3, 4, /* var */ ABSOLUTEx),
Op::new(LDA_ABS_X, 3, 4 /* var */, ABSOLUTEx),
Op::new(LDX_ABS_Y, 3, 4, /* var */ ABSOLUTEy),
ILLEGAL,

// Cx
Op::new(CPY_IMM, 2, 2, IMMEDIATE),
Op::new(CMP_IND_X, 2, 6, INDIRECTx),
ILLEGAL,
ILLEGAL,
Op::new(CPY_ZP, 2, 3, ZEROPAGE),
Op::new(CMP_ZP, 2, 3, ZEROPAGE),
Op::new(DEC_ZP, 2, 5, ZEROPAGE),
ILLEGAL,
Op::new(INY, 1, 2, ZERO),
Op::new(CMP_IMM, 2, 2, IMMEDIATE),
Op::new(DEX, 1, 2, ZERO),
ILLEGAL,
Op::new(CPY_ABS, 3, 4, ABSOLUTE),
Op::new(CMP_ABS, 3, 4, ABSOLUTE),
Op::new(DEC_ABS, 3, 6, ABSOLUTE),
ILLEGAL,

// Dx
Op::new(BNE_REL, 2, 2, /* var */ RELATIVE),
Op::new(CMP_IND_Y, 2, 5, /*var */ INDIRECTy),
ILLEGAL,
ILLEGAL,
ILLEGAL,
Op::new(CMP_ZP_X, 2, 4, ZEROPAGEx),
Op::new(DEC_ZP_X, 2, 6, ZEROPAGEx),
ILLEGAL,
Op::new(CLD_IMPL, 1, 2, ZERO),
Op::new(CMP_ABS_Y, 3, 4, /*var */ ABSOLUTEy),
ILLEGAL,
ILLEGAL,
ILLEGAL,
Op::new(CMP_ABS_X, 3, 4, /*var */ ABSOLUTEx),
Op::new(DEC_ABS_X, 3, 7, ABSOLUTEx),
ILLEGAL,

//Ex
Op::new(CPX_IMM, 2, 2, IMMEDIATE),
Op::new(SBC_IND_X, 2, 6, INDIRECTx),
ILLEGAL,
ILLEGAL,
Op::new(CPX_ZP, 2, 3, ZEROPAGE),
Op::new(SBC_ZP, 2, 3, ZEROPAGE),
Op::new(INC_ZP, 2, 5, ZEROPAGE),
ILLEGAL,
Op::new(INX, 1, 2, ZERO),
Op::new(SBC_IMM, 2, 2, IMMEDIATE),
Op::new(NOP_IMPL, 1, 2, ZERO),
ILLEGAL,
Op::new(CPX_ABS, 3, 4, ABSOLUTE),
Op::new(SBC_ABS, 3, 4, ABSOLUTE),
Op::new(INC_ABS, 3, 6, ABSOLUTE),
ILLEGAL,

//Fx
Op::new(BEQ_REL, 2, 2, /*VAR */ RELATIVE),
Op::new(SBC_IND_Y, 2, 5, /*var */ INDIRECTy),
ILLEGAL,
ILLEGAL,
ILLEGAL,
Op::new(SBC_ZP_X, 2, 4, ZEROPAGEx),
Op::new(INC_ZP_X, 2, 6, ZEROPAGEx),
ILLEGAL,
Op::new(SED_IMPL, 1, 2, ZERO),
Op::new(SBC_ABS_Y, 3, 4, /*var */ ABSOLUTEy),
ILLEGAL,
ILLEGAL,
ILLEGAL,
Op::new(SBC_ABS_X, 3, 4, /* var */ ABSOLUTEx),
Op::new(INC_ABS_X, 3, 7, ABSOLUTEx),
ILLEGAL,
